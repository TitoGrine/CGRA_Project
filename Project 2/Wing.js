class Wing extends CGFobject {
    ...
    setBasePos(){
        ...
        this.scene.rotate(this.orientation * Math.PI/15.0, 0.0, 0.0, 1.0);
    ...
    setTipPos(){
        this.scene.translate(this.orientation * 2.0 * Math.cos(this.inner_wing_rotation + Math.PI/15.0), 2.0 * Math.sin(this.inner_wing_rotation + Math.PI/15.0), 0.0);
